...
class _PhoneProfileThreeState extends State<PhoneProfileThree> {
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextButton(
                                        ...
                                        style:
                                            CustomStyles.textButtonZeroSize(),
                                        child: Stack(
                                          children: [
                                            if (image == null) ...[
                                              Center(
  ...
  Future<void> _onSubmit() async {
    List<File> imageList =
        _images.where((element) => element != null).map((e) => e!).toList();
    ...
    for (File image in imageList) {
      String? downloadURL = await FirebaseStorageApi.uploadFile(
          File(image.path), FirebaseStorageApi.uploadPathProfile);
      if (downloadURL == null) {
